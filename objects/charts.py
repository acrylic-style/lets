...
class BeatmapChart(Chart):
    ...
    def __init__(self, old_score, new_score, beatmap_id):
        ...
        """
        super(BeatmapChart, self).__init__("beatmap", f"https://osu.acrylicstyle.xyz/b/{beatmap_id}", "Beatmap Ranking")
...
class OverallChart(Chart):
    ...
    def __init__(self, user_id, old_user_stats, new_user_stats, score, new_achievements, old_rank, new_rank):
        ...
        """
        super(OverallChart, self).__init__("overall", f"https://osu.acrylicstyle.xyz/users/{user_id}", "Overall Ranking")
